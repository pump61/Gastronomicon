...
public class FoodEffect {
    ...
    private static FoodEffect potionEffect(String color, PotionEffectType effectType, int durationSeconds,
        ...
        return new FoodEffect(
            color + PotionEffectTypeHelper.getName(effectType) + " " + NumberUtil.asRomanNumeral(a + 1) + " (" + d + "s)",
            color + PotionEffectTypeHelper.getName(effectType) + " " + NumberUtil.asRomanNumeral(pa + 1) + " (" + pd + "s)",
            (Player player, Boolean isPerfect) -> {
    ...
    public static FoodEffect removePotionEffect(PotionEffectType type) {
        final String desc = "&bClear " + PotionEffectTypeHelper.getName(type) + " Potion Effect";
    ...
    public static FoodEffect giveSlimefunItem(@Nonnull String id, int amount) {
        ...
        if (sfItem == null) {
            Gastronomicon.log(Level.WARNING, "Could not create a FoodEffect that gives Slimefun item \"" + id + "\" because the item does not exist!"
                + "Please make sure Slimefun and its addons are up to date!");
    ...
    public static FoodEffect teleport(int radius) {
        ...
        return new FoodEffect("&7Randomly teleports you within " + r + " blocks",
            "&7Randomly teleports you within " + r + " blocks",
            (Player player, Boolean isPerfect) -> {
    ...
    private static final FoodEffect extinguish = new FoodEffect("&fExtinguish",
        (Player player, Boolean isPerfect) -> {
