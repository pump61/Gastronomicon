...
public class GastroGroups {
    ...
    public static final SubGroup STORAGE_DECO = new SubGroup("storage_deco", GastroStacks.GUIDE_ITEM_STORAGE_DECO);
    ...
    public static final MultiGroup MAIN = new MultiGroup("main", GastroStacks.GUIDE_ITEM_MAIN, TOOLS, STORAGE_DECO, BASIC_MACHINES, ELECTRIC_MACHINES, RAW_INGREDIENTS, FOOD);

    static {
        TOOLS.setCrossAddonItemGroup(true);
        STORAGE_DECO.setCrossAddonItemGroup(true);
