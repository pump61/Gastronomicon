...
public class GastroResearch {
    ...
    public static final Research CULINARY_WORKBENCH = new Research(Gastronomicon.key("culinary_workbench"), startKey + 2, "First Steps", 10);
    ...
    public static final Research FREEZER = new Research(Gastronomicon.key("freezer"), startKey + 5, "Freezer", 17);
    ...
    public static final Research SICKLES = new Research(Gastronomicon.key("sickles"), startKey + 11, "Harvesting Tools", 18);
